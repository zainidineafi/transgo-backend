                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Masukkan Nama" value="{{ old('name', $driver->name) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="address" id="address" placeholder="Alamat" value="{{ old('address', $driver->address) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="js-states form-control" name="gender" id="gender" style="width: 100%">
                                                @foreach ($genders as $key => $value)
                                                    <option value="{{ $key }}" {{ old('gender', $driver->gender) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
